addpath('/files')
path_data = '/input/ccna-03-19/'
path_out  =  '/output/ccna-03-19_preprocess_output'
...
opt.tune(1).subject = 'sub605383';
opt.tune(1).param.t1_preprocess.crop_neck = 0.25;

opt.tune(2).subject = 'sub283205';
opt.tune(2).param.t1_preprocess.crop_neck = 0.25;

opt.tune(3).subject = 'sub701705';
opt.tune(3).param.t1_preprocess.nu_correct.arg = '-distance 125';


files_in = niak_grab_bids(path_data);
