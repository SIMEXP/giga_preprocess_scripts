...
fail_slice_timing_two = {'sub2855292','sub2954327','sub2963911','sub2982653'};
files_in = rmfield(files_in,fail_slice_timing_two)




opt.tune(1).subject = 'sub2139765';
opt.tune(1).param.t1_preprocess.crop_neck = 0.1;

opt.tune(2).subject = 'sub2384809';
opt.tune(2).param.t1_preprocess.crop_neck = 0.1


opt.tune(3).subject = 'sub2927626';
opt.tune(3).param.t1_preprocess.crop_neck = 0.1


opt.tune(4).subject = 'sub2252653';
opt.tune(4).param.t1_preprocess.crop_neck = 0.3;

opt.tune(5).subject = 'sub2298530';
opt.tune(5).param.t1_preprocess.crop_neck = 0.3;

failed_unknown_two = {'sub2252653', 'sub2298530'}
files_in = rmfield(files_in,failed_unknown_two)



opt.psom.max_queued = 125;
opt.flag_verbose = 0;
