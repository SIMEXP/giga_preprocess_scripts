...
path_out  =  '/files/oasis_preprocess_output/'
...
csv_file = csv2cell('failed_subjects.csv');
failed_subjects = csv_file(2:end);

files_in = niak_grab_bids2(input,opt)
...
%opt.tune(1).subject = 'sub30339'
%opt.tune(1).param.t1_preprocess.crop_neck = 0.4
%opt.tune(1).param.t1_preprocess.nu_correct.arg = '-distance 200';

files_in =  rmfield(files_in,'sub30339')
